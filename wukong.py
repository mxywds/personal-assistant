...
class Wukong(object):
    ...
    def init(self):
        ...
        print(
            """
********************************************************
*          personal-assistant - 您的私人助理         *
*          Lowell <ss.ok@foxmail.com>                  *
*          原作者： 潘伟洲 <m@hahack.com>                 *
*               当前版本号:  {}                          *
*     https://gitee.com/mxywds/personal-assistant.git  *
********************************************************

            后台管理端：http://{}:{}
            如需退出，可以按 Ctrl+4 Ctrl+\ 组合键
...
""".format(
        ...
        self.conversation.say(f"{config.get('first_name', '主人')} 你好！我是您的{config.get('robot_name_cn','私人助理')}", True)
